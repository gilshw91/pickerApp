    ...
    <div className="flex flex-col  md:flex-row justify-between space-x-2 space-y-2 ">
      ...
      <div className="flex space-x-2">
        ...
        <div className="flex-col">
          ...
          <p dangerouslySetInnerHTML={{ __html: formatText(plan.description) }} className="text-sky-950 text-sm"></p>
        </div>
      </div>
      <div className="inline-block md:hidden h-[1px] bg-slate-300" />
      <div className="flex items-center justify-center space-x-2">
        <span className="text-l font-bold text-sky-950">{plan.currency}{plan.price}</span>
